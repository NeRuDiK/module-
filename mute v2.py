    ...
    async def ббcmd(self, message): 
        ...
        if message.chat: 
            ...
            if not chat.admin_rights and not chat.creator: 
                return await message.edit("<b>Я здесь лох :(</b>") 
            else: 
        ...
        if entityid not in mutes[chatid]: 
            ...
            if entityid == chatid: 
                return await message.edit("<b>Минус чат</b>") 
            return await message.edit("<b>ДаТыЗаебал</b>") 
        else: 
            ...
            self.db.set("Mute", "mutes", mutes) 
            if entityid == chatid: 
                return await message.edit("<b>Да будет жить этот величайший чат</b>") 
            return await message.edit("<b>Живи сюк</b>") 
